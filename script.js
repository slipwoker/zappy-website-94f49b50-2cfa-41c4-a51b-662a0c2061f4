document.addEventListener('DOMContentLoaded', function () {
        ...
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            setTimeout(function () {
              ...
              el.classList.remove('fade-in', 'animate-on-scroll', 'reveal');
            }, parseInt(delay, 10));
  ...
  // ============================================================
  // GENERAL SCROLL HANDLER (COMBINED rAF)
  // ============================================================
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Olga Graids uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '94f49b50-2cfa-41c4-a51b-662a0c2061f4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '94f49b50-2cfa-41c4-a51b-662a0c2061f4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '94f49b50-2cfa-41c4-a51b-662a0c2061f4';
